    ...
    >
      <div
        className={cn(
          ...
          isDark
            ? "bg-gradient-to-r from-slate-900/90 to-slate-800/60 border-slate-800/60"
      ...
      >
              ...
              {logs.length > 0 && (
                <>
                  ...
                  <span className="text-blue-500 dark:text-blue-400">
                    {levelCounts.INFO || 0} info
                  </span>
                  <span className="text-amber-600 dark:text-amber-400">
                    {levelCounts.WARN || 0} warn
                  </span>
                  <span className="text-rose-600 dark:text-rose-400">
                    {levelCounts.ERROR || 0} error
                  </span>
                </>
              )}
            </div>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          >
            <Copy size={18} />
            {copied && (
              <span className="absolute -top-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-emerald-500 text-white text-sm font-bold rounded shadow-lg whitespace-nowrap">
                Copied!
              </span>
            )}
          </button>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                ...
                isDark
                  ? "bg-slate-950 border-slate-800 text-slate-300 placeholder:text-slate-600 focus:border-cyan-500/50"
      ...
      >
        ...
        {(["ALL", "INFO", "WARN", "ERROR", "DEBUG", "TRACE"] as const).map(
          (level) => (
            <button
              key={level}
          ...
          <div className="p-2 sm:p-3 space-y-1">
            ...
            {isPaused && (
              <div className="sticky bottom-3 left-0 right-0 flex justify-center">
                <span className="px-3 py-1 bg-amber-500/20 text-amber-600 dark:text-amber-400 text-sm font-bold rounded-full shadow-lg backdrop-blur-md border border-amber-500/30">
                  ⏸ Log updates paused
                </span>
              </div>
            )}
      ...
      <div
        className={cn(
          "flex items-center justify-between px-5 py-2.5 border-t text-sm font-medium",
          isDark
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className={isDark ? "text-slate-800" : "text-slate-300"}>
            |
          </span>
          <span>
