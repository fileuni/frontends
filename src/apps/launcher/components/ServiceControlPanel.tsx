        ...
        {supportService && (
          <div className="relative z-30" ref={serviceMenuRef}>
            ...
            >
              <Settings
                size={20}
                className={showServiceMenu ? "rotate-90" : ""}
              />
            </button>
              ...
              >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isDark
                      ? "border-white/5 hover:bg-rose-500/10 text-slate-200 hover:text-rose-400"
                      : "border-slate-100 hover:bg-rose-50 text-slate-800 hover:text-rose-600",
                  )}
                >
                ...
                <div
                  className={cn(
                    ...
                    isDark
                      ...
                      : "border-slate-100 bg-gray-50/50",
                  )}
                >
                  <div
                    className={cn(
                  ...
                  <label className="flex items-center justify-between gap-3 cursor-pointer group/label">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(event) =>
                          onInstallAutostartChange(event.target.checked)
                        }
                      />
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className={cn(
            ...
            (isLoading || disableToggle) &&
              "opacity-50 grayscale hover:translate-y-0 shadow-none",
          )}
        >
          {isRunning ? (
