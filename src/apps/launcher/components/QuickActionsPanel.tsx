        ...
        >
          <div
            className={cn(
              ...
              isDark
                ? "bg-blue-500/10 group-hover:bg-white/20"
                : "bg-blue-500/10 group-hover:bg-white/20",
            )}
          >
            <Globe
          ...
          >
            <div
              className={cn(
                ...
                showConfigMenu
                  ? "bg-white/20"
                  : "bg-cyan-500/10 group-hover:bg-white/20",
              )}
            >
              <Settings
                size={18}
              ...
              <button
                ...
                className={cn(
                  ...
                  isDark
                    ...
                    : "border-slate-100 hover:bg-gray-50 text-slate-700",
                )}
              >
                <div className="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center group-hover/item:bg-blue-500 group-hover/item:text-white transition-all">
                  <FileCode size={16} />
              ...
              {onResetAdminPassword && (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3.5 p-4 border-t transition-all text-left group/item",
                    isDark
                      ? "border-white/5 hover:bg-rose-500/10 text-slate-300 hover:text-rose-400"
                      : "border-slate-100 hover:bg-rose-50 text-slate-700 hover:text-rose-600",
                  )}
                >
        ...
        >
          <div
            className={cn(
              "w-9 h-9 rounded-lg flex items-center justify-center transition-all",
              isDark
                ? "bg-amber-500/10 group-hover:bg-white/20"
                : "bg-amber-500/10 group-hover:bg-white/20",
            )}
          >
            <BookOpen
          ...
          >
            <div
              className={cn(
                "w-9 h-9 rounded-lg flex items-center justify-center transition-all",
                isDark
                  ? "bg-fuchsia-500/10 group-hover:bg-white/20"
                  : "bg-fuchsia-500/10 group-hover:bg-white/20",
              )}
            >
              <Info
