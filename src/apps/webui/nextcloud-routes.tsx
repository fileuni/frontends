...
const NextcloudLoginView = lazy(() =>
  import("@/components/public/components/NextcloudLoginView").then((m) => ({
    default: m.NextcloudLoginView,
  })),
);
const NextcloudDirectEditingView = lazy(() =>
  import("@/components/public/components/NextcloudDirectEditingView").then(
    (m) => ({ default: m.NextcloudDirectEditingView }),
  ),
);
