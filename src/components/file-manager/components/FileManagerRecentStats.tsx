  ...
  return (
    <div className="px-6 py-3 bg-primary/5 border-b border-white/5 flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <p className="text-sm font-bold opacity-40 tracking-wider">
          {t("filemanager.recentRules") || "History covers: directory browsing, property checks, previews, and downloads."}
        </p>
      </div>
      <Button variant="ghost" size="sm" className="h-9 text-sm font-black text-red-400 hover:text-red-500 hover:bg-red-500/10" onClick={onClear}>
