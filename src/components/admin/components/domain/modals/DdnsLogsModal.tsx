        ...
        <div className={glassSectionCardBase}>
          <div className="flex items-center justify-between gap-4">
            <div className="min-w-0">
              <div className="text-sm font-black tracking-widest opacity-70 truncate">{entry.name}</div>
              <div className="mt-1 text-[14px] font-mono opacity-60 truncate">{entry.fqdn}</div>
            </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="py-3 text-[12px] font-black tracking-widest opacity-50">IP</th>
                  <th className="py-3 text-[12px] font-black tracking-widest opacity-50">
