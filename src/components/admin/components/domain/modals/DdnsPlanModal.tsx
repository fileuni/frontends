                    ...
                    return (
                      <tr key={it.id} className="border-b border-white/10 last:border-0">
                        <td className="py-3">
                          ...
                          <div className="mt-1 truncate text-[14px] font-mono opacity-60">{it.fqdn}</div>
                          <div className="mt-1 text-[12px] font-bold opacity-40">{it.provider_key}</div>
                        </td>
                        <td className="py-3">
                          <Badge variant="outline" className={cn('h-7 rounded-lg px-2 font-black tracking-widest', actionColor)}>
                            {it.action}
                          </Badge>
                        </td>
                        <td className="py-3 whitespace-nowrap text-[14px] font-mono opacity-70">
                          {it.desired_ipv4 ? `want ${it.desired_ipv4}` : '-'}
                          {it.dns_error_ipv4 ? <div className="text-[12px] text-orange-400">dns err</div> : null}
                        </td>
                        <td className="py-3 whitespace-nowrap text-[14px] font-mono opacity-70">
                          {it.desired_ipv6 ? `want ${it.desired_ipv6}` : '-'}
                          {it.dns_error_ipv6 ? <div className="text-[12px] text-orange-400">dns err</div> : null}
                        </td>
