    ...
    try {
      ...
      if (isRecord(root)) {
        ...
        setCacheSection({
          ...
          readLocalDir: typeof readCache.local_dir === 'string' ? readCache.local_dir : '{RUNTIMEDIR}/cache/vfs-read',
          ...
          writeLocalDir: typeof writeCache.local_dir === 'string' ? writeCache.local_dir : '{RUNTIMEDIR}/cache/vfs-write',
                ...
                <div className="space-y-3">
                  ...
                  {connectors.map((connector, index) => (
                    <ConnectorCard
                      ...
                      onPickConnectorRoot={(id) => { void pickConnectorRoot(id); }}
                    />
                  ))}
                </div>
              )}
