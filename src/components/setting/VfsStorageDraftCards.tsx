...
const fieldClassName = (isDark: boolean) =>
  cn(
...
const focusedFieldClassName = (isDark: boolean) =>
  cn(
...
const actionButtonClassName = (isDark: boolean) =>
  cn(
...
const dangerButtonClassName = (isDark: boolean) =>
  cn(
    "h-9 px-3 rounded-lg border text-sm font-black inline-flex items-center gap-2 transition-colors",
    isDark
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            className={cn(
              "h-8 px-2 rounded-lg border text-xs font-black inline-flex items-center gap-2 transition-colors",
              actionButtonClassName(isDark),
            )}
            onClick={onAdd}
          >
            <Plus size={14} />
        ...
        <div className="mt-2 space-y-2">
          {pairs.map((pair, pairIndex) => (
            <div
              key={`${ownerId}-${pair.key || "empty-key"}-${pair.value || "empty-value"}`}
            ...
            >
              <input
                ...
                value={pair.key}
                onChange={(event) =>
                  onUpdate(pairIndex, { key: event.target.value })
                }
              />
              <input
                className={fieldClassName(isDark)}
                ...
                value={pair.value}
                onChange={(event) =>
                  onUpdate(pairIndex, { value: event.target.value })
                }
              />
              <button
                type="button"
              ...
              >
                ...
                {field.secret ? (
                  <PasswordInput
                    ...
                    onChange={(event) =>
                      onChangeOption(field.key, event.target.value)
                    }
                  />
                ) : (
                  <input
                ...
                <div
                  className={cn(
                    "mt-1 text-xs font-bold opacity-60",
...
export const ConnectorCard = memo(
  ({
    ...
    onUpdateConnector: (
      id: string,
      updater: (prev: ConnectorDraft) => ConnectorDraft,
    ) => void;
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          {showDeleteButton && (
            <button
              ...
              title={
                !allowDelete
                  ? t("admin.config.storage.validation.minimumOneConnector")
                  : undefined
              }
            >
              <Trash2 size={16} />
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          >
            ...
            <input
              ...
              onChange={(event) =>
                onRenameConnector(connector.id, event.target.value)
              }
            />
          </label>
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            title={
              !allowDelete
                ? t("admin.config.storage.validation.minimumOnePool")
                : undefined
            }
          >
            <Trash2 size={16} />
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          >
            ...
            <input
              className={focusedFieldClassName(isDark)}
              value={pool.name}
              onChange={(event) => onRenamePool(pool.id, event.target.value)}
            />
          </label>
          ...
          >
            ...
            <select
              className={fieldClassName(isDark)}
              value={pool.primary_connector}
              onChange={(event) =>
                onUpdatePool(pool.id, (prev) => ({
                  ...prev,
                  primary_connector: event.target.value,
                }))
              }
            >
              {connectorNames.map((name) => (
                <option key={`${pool.id}-primary-${name}`} value={name}>
                  {name || "(unnamed)"}
                </option>
              ))}
            </select>
          ...
          >
            ...
            <select
              className={fieldClassName(isDark)}
              value={pool.backup_connector}
              onChange={(event) =>
                onUpdatePool(pool.id, (prev) => ({
                  ...prev,
                  backup_connector: event.target.value,
                }))
              }
            >
              <option value="">{t("common.none")}</option>
              {connectorNames.map((name) => (
                <option key={`${pool.id}-backup-${name}`} value={name}>
                  {name || "(unnamed)"}
                </option>
              ))}
            </select>
          ...
          >
            ...
            <div className="mt-1">
              <input
                type="checkbox"
                className="h-5 w-5"
                checked={pool.enable_write_cache}
                onChange={(event) =>
                  onUpdatePool(pool.id, (prev) => ({
                    ...prev,
                    enable_write_cache: event.target.checked,
                  }))
                }
              />
            </div>
      ...
      >
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
          ...
          >
            ...
            >
              {poolNames.map((name) => (
                <option key={`${policy.id}-${name}`} value={name}>
                  {name || "(unnamed)"}
                </option>
              ))}
            </select>
          ...
          >
            ...
            <input
              ...
              onChange={(event) =>
                onUpdatePolicy(policy.id, (prev) => ({
                  ...prev,
                  default_quota: event.target.value,
                }))
              }
            />
          </label>
          ...
          >
            ...
            <input
              ...
              onChange={(event) =>
                onUpdatePolicy(policy.id, (prev) => ({
                  ...prev,
                  max_private_mounts: event.target.value,
                }))
              }
            />
          </label>
          ...
          >
            ...
            <input
              ...
              onChange={(event) =>
                onUpdatePolicy(policy.id, (prev) => ({
                  ...prev,
                  min_mount_sync_interval_minutes: event.target.value,
                }))
              }
            />
          </label>
          ...
          >
            ...
            <input
              ...
              onChange={(event) =>
                onUpdatePolicy(policy.id, (prev) => ({
                  ...prev,
                  max_mount_sync_timeout_secs: event.target.value,
                }))
              }
            />
          </label>
