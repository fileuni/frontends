...
export const DashboardLayout: React.FC<{
  ...
  const { navItems, adminItems } = useMemo(() => ({
    ...
    adminItems: [
      ...
      { name: "DDNS 动态域名", icon: "Globe", m: "admin", p: "domain-ddns", path: "#mod=admin&page=domain-ddns" },
      { name: "SSL/TLS 证书", icon: "ShieldCheck", m: "admin", p: "domain-ssl", path: "#mod=admin&page=domain-ssl" },
